...
export function usePrayerTimes() {
  ...
  // Recalculate prayer times when settings, location, date, or timezone change
  ...
  }, [location.coordinates, date, settings.calculationMethod, settings.asrCalculation, timezone]);
